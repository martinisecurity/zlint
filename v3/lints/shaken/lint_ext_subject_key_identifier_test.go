...
func Test_ExtSubjectKeyIdentifier(t *testing.T) {
	type args struct {
		lintName string
	...
	tests := []struct {
		...
		{
			name: "e_atis_subject_key_identifier leaf",
			args: args{
				lintName: "e_atis_subject_key_identifier",
				cert: &x509.Certificate{
		...
		{
			name: "e_atis_subject_key_identifier leaf not found",
			args: args{
				lintName: "e_atis_subject_key_identifier",
				cert: &x509.Certificate{
					NotBefore:  util.ATIS1000080_v003_Leaf_Date,
		...
		{
			name: "e_atis_subject_key_identifier_ca intermediate",
			args: args{
				lintName: "e_atis_subject_key_identifier_ca",
				cert: &x509.Certificate{
		...
		{
			name: "e_atis_subject_key_identifier_ca root",
			args: args{
				lintName: "e_atis_subject_key_identifier_ca",
				cert: &x509.Certificate{
					NotBefore:  util.ATIS1000080_v003_Date,
